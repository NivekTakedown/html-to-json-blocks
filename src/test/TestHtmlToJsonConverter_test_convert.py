...
class TestHtmlToJsonConverterComplex(unittest.TestCase):
    ...
    def test_complex_html_structure(self):
        ...
        expected = [
            {"type": "heading", "children": [{"text": "Header 1", "type": "text"}], "level": 1, "size": "h1"},
            {
                "type": "paragraph",
                "children": [
                    {"text": "Paragraph with", "type": "text"},
                    {
                        "type": "link",
            ...
            },
            {
                ...
                "format": "unordered",
                "children": [
                    {"type": "list-item", "children": [{"text": "List item 1", "type": "text"}]},
                    {"type": "list-item",
                     "children": [{"text": "List item 2 with"}, {"italic": True, "text": " italic ", "type": "text"},
                                  {"text": "text", "type": "text"}]}
                ]
            },
            {"type": "image", "image": {"url": "image.png", "caption": "An image", "width": 100, "height": 100},
             "children": [{"text": "", "type": "text"}]}
        ]
